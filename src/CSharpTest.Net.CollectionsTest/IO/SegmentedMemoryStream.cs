...
namespace CSharpTest.Net.IO
{
    ...
    public class SegmentedMemoryStream : Stream
    {
        ...
        /// </summary>
        public override bool CanRead => _position >= 0;

        /// <summary>
        ///     When overridden in a derived class, gets a value indicating whether the current stream supports seeking.
        /// </summary>
        public override bool CanSeek => _position >= 0;

        /// <summary>
        ///     When overridden in a derived class, gets a value indicating whether the current stream supports writing.
        /// </summary>
        public override bool CanWrite => _position >= 0;
        ...
        private class Contents
        {
            ...
            public byte[] this[int index] => _segments[index];
            ...
            public void GrowTo(int newSegmentCount)
            {
                lock (this)
                {
                    ...
                    {
                        _segments[_segmentCount] = new byte[SegmentSize];
                        _segmentCount++;
                    }
                }
            }
