...
namespace CSharpTest.Net.Bases
{
        ...
        where T : Comparable<T>
    {
        ...
        public new static readonly EqualityComparer Comparer = new EqualityComparer();
        ...
        {
            return (object) other == null ? false : 0 == CompareTo(other);
        }
        ...
        [DebuggerNonUserCode]
        public new sealed class EqualityComparer : Comparer<T>, IEqualityComparer<T>, IComparer<T>
        {
