...
namespace CSharpTest.Net.Collections
{
    ...
    public class OrderedKeyValuePairs<TKey, TValue> : OrderedEnumeration<KeyValuePair<TKey, TValue>>
    {
        ...
        /// </summary>
        public static IEnumerable<KeyValuePair<TKey, TValue>> Merge(IComparer<TKey> comparer,
            params IEnumerable<KeyValuePair<TKey, TValue>>[] enums)
        {
        ...
        /// </summary>
        public static IEnumerable<KeyValuePair<TKey, TValue>> Merge(IComparer<TKey> comparer,
            DuplicateHandling duplicateHandling, params IEnumerable<KeyValuePair<TKey, TValue>>[] enums)
        {
